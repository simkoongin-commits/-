...
test("saved record parsing rejects malformed data", () => {
  ...
  assert.deepEqual(parseHeartFiveRecord("record-1", valid), { id: "record-1", place: "미지정", mode: "원사", finalized: true, ...valid });
  assert.equal(parseHeartFiveRecord("draft", { ...valid, finalized: false })?.finalized, false);
